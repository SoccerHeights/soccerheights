  ...
  const GameCard = ({g,admin}) => {
    ...
    return <Card style={{marginBottom:10}}>
      ...
      {admin&&<div style={{display:"flex",gap:6,marginTop:12,justifyContent:"center",flexWrap:"wrap"}}>
        ...
        {g.done&&<Btn sz="sm" v="secondary" icon="edit" onClick={()=>{setForm({gid:g.id,hs:String(g.hs),as:String(g.as),h:g.h,a:g.a,videoUrl:g.videoUrl||"",forfeit:!!g.forfeit});setModal("score");}}>Edit Score</Btn>}
